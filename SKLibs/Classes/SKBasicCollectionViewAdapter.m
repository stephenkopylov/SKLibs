//
//  SKBasicCollectionViewAdapter.m
//  PandraLibs
//
...
@implementation SKBasicCollectionViewAdapter

-(void)registerView:(id)view{
    self.view = view;
    self.view.delegate = self;
    self.view.dataSource = self;
    [self.view  registerClass:[SKBasicLoadingCell class] forCellWithReuseIdentifier:@"loadingCell"];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    if (self.view.loadingMoreEnabled && indexPath.row == [self collectionView:collectionView numberOfItemsInSection:indexPath.section] - 1)
    {
        ...
        SKBasicLoadingCell *cell = [self.view dequeueReusableCellWithReuseIdentifier:@"loadingCell" forIndexPath:indexPath];
...
- (SKBasicLoadingCell *)prepareLoadingCell:(SKBasicLoadingCell *)cell withIndexPath:(NSIndexPath *)indexPath {
